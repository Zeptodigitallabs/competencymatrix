...
const EvidenceView = () => {
    ...
    const { isCurrentUser = true, userName = '' } = location.state || {};
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <h2 className="text-2xl font-bold mb-6">
                {isCurrentUser ? 'My Competency' : `Competency For ${userName}`}
            </h2>
            <div className="flex border-b mb-6">
                <button
                    className={`py-2 px-4 font-medium ${activeTab === 'achieved'
                ...
                <button
                    className={`py-2 px-4 font-medium ${activeTab === 'inProgress'
                        ? 'border-b-2 border-blue-500 text-blue-600'
                        : 'text-gray-500'
                        }`}
